...
// (Content copied from docs/static/js/script.js)
// Global variables
let video = null;
let stream = null;
...
// Helper to read the static base (where static assets are hosted). Don't declare
// globals here to avoid conflicting with per-page scripts that may run in the
// global scope.
...
// Create audio objects using the computed static base
